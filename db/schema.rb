...
ActiveRecord::Schema.define(version: 2021_10_02_020301) do
  ...
  create_table "record_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "last_name_canat", null: false
    t.string "first_name_canat", null: false
